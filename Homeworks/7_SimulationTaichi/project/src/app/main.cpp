...
void add_jet() {
    add_object_rectangle(Vec(0.05, 0.5), Vec(0.06, 0.02), 0x87CEFA, 80, Vec(10.0, 5.0), 0);
    //add_object_rectangle(Vec(0.5, 0.5), Vec(0.5, 0.1), 0x87CEFA, 10, Vec(0.0, 10.0));
}
////////////////////////////////////////////////////////////////////////////////
int main() {
    ...
    int num = 130;
   // add_object_rectangle(Vec(0.1, 0.2), Vec(0.12, 0.18), 0xED553B, num, Vec(50, 0), 1);
    add_object_rectangle(Vec(0.35, 0.3), Vec(0.55, 0.02), 0xFFFAFA, 2000, Vec(0, 0), 2);
    //add_object(Vec(0.5,0.1), 0xFFFAFA, 1);
  ...
  ////////////////////////////////////////////////////////////////////////////////
    ...
    for (int i = 0;; i++) {                              //              Main Loop
        ...
        if (i % int(frame_dt / dt) == 0) {                 //        Visualize frame
            ...
            /*if (i < 1000 && i % 150 == 0) 
            {
                double h=std::rand() % 4 / 10.0;
                add_object_rectangle(Vec(0.1, 0.2+h), Vec(0.12, 0.18+h), 0xED553B, num, Vec(50, 0), 1);
                double h2 = std::rand() % 4 / 10.0;
                add_object_rectangle(Vec(0.8, 0.2 + h2), Vec(0.82, 0.18 + h2), 0xED553B, num, Vec(-50, 0), 1);
            }*/

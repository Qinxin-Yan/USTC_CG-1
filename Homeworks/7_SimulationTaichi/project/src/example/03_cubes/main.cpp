...
void add_jet() {
    add_object_rectangle(Vec(0.05, 0.3), Vec(0.06, 0), 0x87CEFA, 15, Vec(10.0, 3.0),0);
...
/***********************************(5)*****************************************/
  ...
  add_object_rectangle(Vec(0.5, 0.3), Vec(0.7, 0.02), 0xFFFAFA, 1000, Vec(0, 0), 2);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  for (int i = 0;; i++) {                              //              Main Loop
    ...
    if (i % int(frame_dt / dt) == 0){                 //        Visualize frame
      ...
      //if (i % 1000 == 0)
     // {
          //for (int k = 0; k < num; k++) particles[i].SetVelovity(Vec(0, 10));
      //}
    }
  }
} //----------------------------------------------------------------------------
